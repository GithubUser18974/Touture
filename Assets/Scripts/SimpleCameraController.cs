...
namespace UnityTemplateProjects
{
    public class SimpleCameraController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                this.gameObject.GetComponent<SimpleCameraController>().enabled = false;
            }
            OriginalRotat = playerCamera.transform.eulerAngles;
            playerOrientation_X = OriginalRotat.x;
            playerOrientation_Y= OriginalRotat.y;
        }
